...
const manufacturing = {
  ...
  docs: [
    { id: "d1", name: "금형설계_표준_및_도면작성기준_DS-STD-04.pdf", size: "3.4 MB", date: "2026.01.12", tags: ["대외비", "DRM 자동해제"], secLevel: "C" },
      ...
      answer: {
        ...
        xai: {
          ...
          sources: [
            ...
            { name: "금형설계_표준_및_도면작성기준_DS-STD-04.pdf", similarity: 90 },
  ...
  // (sampleAnswers 금형 답변과 같은 세계관: 축적 도면 12,400장·기준 도면 M-204 유사도 92%·리드타임 5.2일→1.8일)
  {
    ...
    stages: [
      ...
      },
      {
        ...
        review: "아웃라인은 기본 설계 초안입니다 — 금형설계 담당 검토와 정재호 생산기술팀장 승인 후 3D 모델링에 착수합니다.",
        handoff: null,
      },
    ],
    result: {
