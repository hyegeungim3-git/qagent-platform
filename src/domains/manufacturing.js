...
const manufacturing = {
  ...
  suggestions: [
    ...
    { icon: Ruler,      iconBg: "bg-indigo-50",  iconColor: "text-indigo-600",  title: "금형 설계 지원",   query: "신규 브래킷 금형(M-318) 설계에 참고할 유사 도면을 찾아 설계 아웃라인을 만들어줘" },
  ...
  modeDesc: {
    GENERAL: "설비 데이터 표준화, 금형 설계, 품질 예측 등 제조 AI 전환(M.AX) 업무를 자유롭게 질문하세요",
  },
  agentFeed: {
    recent: [
      { agentId: "agent-knowledge",    agentName: "도면 온톨로지", time: "오늘 14:32", result: "M-318 유사 금형 도면 5건 검색" },
  ...
  notifications: [
    ...
    { id: "n2", severity: "warn", title: "신규 금형 설계 사양 접수", body: "브래킷 금형 M-318 설계 사양서(12면) 접수 — 유사 도면 검색·설계 아웃라인 생성 대기 중입니다.", time: "08:05", link: { agentId: "orchestration:2" } },
  ...
  // 시나리오 3 — 온톨로지 설계 지원: 신규 금형 사양서 1건이 사양 판독→유사 도면 검색→아웃라인 생성→설계 검토를 릴레이
  // (sampleAnswers 금형 답변과 같은 세계관: 축적 도면 12,400장·기준 도면 M-204 유사도 92%·리드타임 5.2일→1.8일)
  {
    title: "금형 설계 아웃라인 자동 생성",
    brief: "신규 금형 사양서 1건이 사양 판독 → 유사 도면 검색(온톨로지) → 설계 아웃라인 생성 → 설계 검토·간섭 체크로 자동 릴레이됩니다.",
    request: "신규 브래킷 금형(M-318) 설계 사양서를 판독해서 축적 도면 중 유사한 금형을 찾고, 기본 설계 아웃라인을 만든 다음 간섭·성형성 검토까지 해줘.",
    ...
    stages: [
      {
        ...
        handoff: "구조화된 사양 34항목을 금형 도면 온톨로지 검색 에이전트로 전달",
      },
      {
        agentId: "agent-knowledge", ms: 3400,
        task: "금형 도면 온톨로지에서 형상·치수·재질이 유사한 과거 도면을 검색합니다.",
        logs: [
          "금형 도면 온톨로지 조회 — 축적 도면 12,400장 색인 대상",
      ...
      },
      {
        ...
        logs: [
          "금형설계 표준 DS-STD-04 대조 — 필수 기재 항목 28개 중 26개 충족",
    ...
    result: {
      ...
      docTitle: "M-318 브래킷 금형 기본 설계 아웃라인 패키지 (유사도면 대조표 첨부)",
      summary: [
  ...
  agentCatalog: {
    ...
    "agent-knowledge":    { name: "금형 도면 온톨로지 검색 에이전트", shortName: "도면 온톨로지", desc: "금형 도면 12,400장을 형상·치수·가공조건 온톨로지로 색인해 유사 도면(최대 유사도 92%)을 찾고, 신규 설계 아웃라인과 검토 포인트를 함께 제시합니다." },
...
부적합 발생 시 라인을 정지하고 부적합품 관리 지침에 따라 식별·격리한다. 점검·교체 기록은 MES 전자기록으로 **5년간 보존**하며, 기록 관리 부실 시 관련 규정에 따라 조치한다.`,
    ...
    "agent-knowledge": {
      ...
      knowledgeBases: [
        { id: 'kb1', name: '금형 도면 온톨로지 (12,400장)', docs: 12400, updated: '2026.03.02', icon: BookMarked, color: 'violet' },
        { id: 'kb2', name: '금형 설계 표준·체크리스트',     docs: 26,    updated: '2026.02.18', icon: FileText,   color: 'blue' },
        ...
        { id: 'kb5', name: '금형 트러블슈팅 사례집',        docs: 63,    updated: '2026.03.05', icon: FileText,   color: 'emerald' },
      ...
      recentSearches: [
        { id: 1, query: '드로잉 금형 주름 방지 설계 사례', date: '2026-03-31 16:20', results: 5 },
        { id: 2, query: 'SPCC 2.0T 굽힘 스프링백 보정값', date: '2026-03-30 10:12', results: 4 },
        { id: 3, query: '프로그레시브 금형 스테이지 배치', date: '2026-03-28 14:55', results: 7 },
      ],
      results: [
        {
          id: 1, title: 'HBM-2211 브래킷 굽힘 금형 (프로그레시브 5스테이지)', source: '금형도면_HBM-2211_Rev.C.dwg',
        ...
        {
          id: 4, title: '금형 간섭 체크 및 성형 시뮬레이션 절차', source: '금형설계표준_DIE-STD-07.pdf',
...
5. 후속 조치: 치료 종료 후 30일 이내에 결과 보고서를 제출하며, 해당 작업의 위험성평가를 재실시하고 재발 방지 대책을 수립하여 안전환경팀에 공유합니다.`,
    ...
    "agent-chatbot": {
      ...
      delegateRules: [
        ...
        { keywords: ['도면', '설계', '금형'],          agentId: 'agent-knowledge',    agentName: '금형 도면 온톨로지 검색 에이전트', reason: '유사 도면 검색과 설계 아웃라인 초안 제시 전문입니다.' },
      ...
      quickAgents: [
        { label: '금형 도면 온톨로지 검색',    id: 'agent-knowledge',   color: 'bg-violet-100 text-violet-700' },
  ...
  /* ── SECURE 탭 제안 4종 ── */
  secureSuggestions: [
    { icon: FileText,    iconBg: "bg-blue-950/50", iconColor: "text-blue-400", title: "금형 도면 외부 공유 검토",  query: "협력사에 전달할 금형 도면에서 외부 공유 시 삭제해야 할 기밀 항목(공정조건·다이 클리어런스)을 골라줘. 결과는 저장되지 않아" },
  ...
  adminContent: {
    ...
    MOCK_EMBEDDING_JOBS: [
      ...
      {id:910,name:'금형 도면 온톨로지 임베딩 v1 (12,400장)',plan:'BGE-m3-ko',creator:'정재호',dept:'생산기술팀',date:'2026-01-28 22:35:46',gpu:'A100 x2',tbStatus:'실행 중',status:'학습 완료'},
    ...
    MOCK_MCP_TOOLS: [
      ...
      {id:150,name:'DrawingSimilarity',desc:'금형 도면 형상·치수 유사도 검색 (온톨로지 12,400장)',creator:'정재호',dept:'생산기술팀',date:'2025-12-24 16:24:45'},
    ...
    MOCK_PROMPTS: [
      ...
      {id:381,name:'[전용] 금형 설계 아웃라인 생성',desc:'유사 도면 상위 5건 기반 설계 아웃라인·검토 포인트 초안 생성',dept:'생산기술팀',date:'2026-01-22 04:27:45'},
    ...
    MOCK_CHAT_APPS: [
      ...
      {id:1645,name:'금형 설계 지원 챗봇',type:'전용 채팅',status:'Online',deploy:'배포',creator:'정재호',dept:'생산기술팀',addr:'/apps/die-design'},
    ...
    MOCK_RERANK_PIPELINES: [
      ...
      {id:'rp-007',agent:'금형 도면 온톨로지 검색 에이전트',model:'ColBERT-v2-Kor',topK:5,threshold:0.72,enabled:true,improvement:24.6},
    ],
    ...
    MOCK_RAG_AREAS: [
      ...
      {id:'KA-007',area:'금형 도면 온톨로지',topK:8,threshold:0.72,chunkSize:256,override:true,updated:'2026-03-02'},
    ],
    ...
    MOCK_PERMISSION_REQUESTS: [
      ...
      {id:'PRM-005',user:'박태윤',dept:'생산기술팀',type:'데이터 등급 권한',target:'등급 A(극비) 금형 도면 원본 열람 롤',status:'대기 중',date:'2026-02-13'},
      {id:'PRM-006',user:'한지원',dept:'품질관리부',type:'지식영역 접근',target:'금형 도면 온톨로지(KA-007)',status:'완료',date:'2026-02-12'},
    ],
    ...
    MOCK_KNOWLEDGE_AREAS: [
      ...
      {id:'KA-007',name:'금형 도면 온톨로지',desc:'금형 도면 12,400장의 형상·치수·가공조건 색인 및 설계 표준',docs:12400,chunks:86400,size:'6.4 GB',owner:'생산기술팀',access:['생산기술팀','품질관리부'],updated:'2026-03-02',status:'Running'},
    ],
    ...
    MOCK_KB_FOLDERS: [
      ...
      {id:'f-006',name:'금형 도면 온톨로지',parent:null,docs:12400,perm:'specific',owner:'생산기술팀'},
      {id:'f-061',name:'프로그레시브 금형',parent:'f-006',docs:5240,perm:'specific',owner:'생산기술팀'},
    ],
    MOCK_KB_DOCS: {
      'f-001':[
      ...
      'f-006':[
        {id:'d-051',name:'금형설계표준_DIE-STD-04.pdf',size:'3.4MB',pii:false,status:'완료',chunks:186,uploaded:'2026-02-18',uploader:'정재호'},
        {id:'d-052',name:'금형_트러블슈팅_사례집.pdf',size:'9.6MB',pii:false,status:'완료',chunks:512,uploaded:'2026-03-05',uploader:'박태윤'},
      ],
      'f-061':[
        {id:'d-061',name:'금형도면_HBM-2211_Rev.C.dwg',size:'6.8MB',pii:false,status:'완료',chunks:42,uploaded:'2026-03-02',uploader:'정재호'},
        {id:'d-062',name:'금형도면_HBM-1987_Rev.B.dwg',size:'5.2MB',pii:false,status:'완료',chunks:38,uploaded:'2026-03-01',uploader:'박태윤'},
      ],
    },
    MOCK_BATCH_JOBS: [
      ...
      {id:'bj-006',src:'PLM',target:'금형 도면 온톨로지',schedule:'매주 토 02:00',lastRun:'2026-02-21 02:00',lastResult:'성공',addedDocs:48,updatedDocs:12,deletedDocs:2,enabled:true},
    ],
    MOCK_SYNC_LOGS: [
      ...
      {id:7,time:'2026-02-21 02:00:52',src:'PLM',folder:'금형 도면 온톨로지',file:'금형도면_HBM-2211_Rev.C.dwg',action:'추가',pii:false,status:'완료'},
    ],
    ...
    MOCK_USAGE_HISTORY: [
      ...
      {id:'uh-007',user:'정재호',dept:'생산기술팀',mode:'GENERAL',query:'SPCC 2.0T 브래킷 굽힘 금형과 비슷한 도면 찾아서 설계 아웃라인 잡아줘',answer:'금형 도면 온톨로지 12,400장에서 유사 도면 5건 검색 — 최고 유사도 HBM-2211(92.0%). 5스테이지 배치·다이 클리어런스 편측 0.16mm·스프링백 보정 1.8°를 반영한 아웃라인 초안...',time:'2026-02-25 15:40',tokens:742,rating:5,errReport:false},
    ...
    MOCK_DOC_PIPELINE: [
      ...
      {id:'dp-008',name:'금형도면_HBM-2211_Rev.C.dwg',folder:'금형 도면 온톨로지',src:'PLM',type:'DWG',size:'6.8MB',ingest:'2026-02-21 02:00',parseStatus:'완료',chunkStatus:'완료',embedStatus:'완료',chunks:42,tokens:6800,pii:false,version:3,changeType:'업데이트'},
    ...
    MOCK_CHUNK_QUALITY: [
      ...
      {docId:'d-051',name:'금형설계표준_DIE-STD-04.pdf',folder:'금형 도면 온톨로지',avgLen:162,specialCharPct:2.4,dupPct:1.1,semanticScore:93,status:'양호'},
      {docId:'d-061',name:'금형도면_HBM-2211_Rev.C.dwg',folder:'금형 도면 온톨로지',avgLen:96,specialCharPct:6.8,dupPct:2.4,semanticScore:74,status:'주의'},
    ],
    MOCK_CHUNK_PREVIEW: [
    ...
    MOCK_QNA_MGMT: [
      ...
      {id:'Q-006',title:'금형 도면을 AI에 올려도 외부로 나가지 않나요?',user:'정재호',dept:'생산기술팀',date:'2026-02-23',status:'답변완료',answer:'도면 원본은 데이터 등급 A로 분류되어 공장 내부망 구축형 모델에서만 처리되며 클라우드 전송 경로가 차단되어 있습니다. 처리 이력은 전량 감사 로그에 기록됩니다.'},
    ],
    MOCK_IP_BLOCKS: [
      {id:'ib-001',target:'192.168.100.45',type:'IP',reason:'비정상 반복 접속 (10분간 500회)',action:'차단',appliedBy:'임수진',date:'2026-02-24',status:'활성'},
      {id:'ib-002',target:'10.20.30.99',type:'IP',reason:'등급 A 금형 도면 원본 권한 외 접근 시도 (12회)',action:'차단',appliedBy:'임수진',date:'2026-02-22',status:'활성'},
    ...
    MOCK_QUALITY_REVIEWS: [
      ...
      {id:'QR-006',query:'SPCC 2.0T 브래킷 굽힘 금형 유사 도면',answer:'HBM-2211(유사도 92.0%) 외 4건 — 5스테이지 배치와 다이 클리어런스 편측 0.16mm 참조 가능...',agent:'금형 도면 온톨로지 검색 에이전트',reviewer:'정재호',rating:'good',confidence:0.92,date:'2026-02-14',feedback:'홀 피치 차이 안내까지 정확'},
    ...
    MOCK_AGENTS: [
      ...
      {id:'AGT-009',name:'금형 도면 온톨로지 검색 에이전트',desc:'금형 도면 12,400장을 형상·치수·가공조건 온톨로지로 색인해 유사 도면과 설계 아웃라인 초안을 제시합니다.',model:'GPT-OSS-120B',tools:['금형 도면 온톨로지 DB','금형 설계 표준 DB'],mcpTools:['MCP-DrawingSimilarity','MCP-Search'],ragEnabled:true,hitl:true,a2a:false,responseMode:'knowledge',actionable:false,status:'Running',version:'v1.2',creator:'정재호',dept:'생산기술팀',created:'2026-02-02',updated:'2026-02-12',requests24h:96,avgLatency:'1.6s',successRate:97.8,confidence:0.92,systemPrompt:'금형 설계 지원 전문 에이전트입니다. 유사 도면의 근거(유사도·차이점)와 설계 검토 포인트를 함께 제시하고, 도면 원본(등급 A)은 본문에 노출하지 않습니다.',temperature:0.2,maxTokens:4096},
    ...
    MOCK_AGENT_DEPLOYS: [
      ...
      {id:'DEP-009',agentId:'AGT-009',agentName:'금형 도면 온톨로지 검색 에이전트',model:'GPT-OSS-120B',version:'v1.2',env:'Production',endpoint:'/api/agent/die-ontology',deployDate:'2026-02-12 09:40',deployer:'정재호',status:'Running',replicas:2,cpu:'4 Core',memory:'16 GB',gpu:'H200 x1',uptime:'2d 6h',requests24h:96,errorRate:2.2},
    ...
    MOCK_WORKFLOWS: [
      ...
      {id:'WF-005',name:'신규 금형 설계 지원 파이프라인',desc:'설계 의뢰 → 유사 도면 검색 → 아웃라인 초안 → 간섭 체크 → DR2 검토(HITL) → PLM 등록',status:'Running',creator:'정재호',created:'2026-02-12',lastRun:'2026-02-14 10:05',runs24h:6,successRate:97.0,protocol:'MCP+A2A',hitl:true,
        steps:[{id:'s1',name:'설계 의뢰 접수',type:'trigger',agentId:null},{id:'s2',name:'MCP-DrawingSimilarity',type:'mcp',agentId:null},{id:'s3',name:'금형 도면 온톨로지 검색 에이전트',type:'agent',agentId:'AGT-009'},{id:'s4',name:'유사도 ≥ 85%',type:'condition',agentId:null},{id:'s5',name:'DR2 설계 검토(HITL)',type:'hitl',agentId:null},{id:'s6',name:'PLM 도면 등록',type:'action',agentId:null}]},
    ...
    MOCK_AIACT_SYSTEMS: [
      ...
      {id:'hi-006',name:'도면 OCR·마스킹 에이전트',dept:'정보보안팀',status:'비해당',confirmedAt:'2026-01-28',manager:'임수진 책임',
       purpose:'스캔 도면·검사성적서 텍스트 추출, 개인정보 자동 마스킹, 금형 도면 온톨로지 색인 전처리',
    ...
    ADMIN_DATASET_ROWS: [
      ...
      {id:6,n:'Die_Drawing_Ontology_Corpus',d:'금형 도면 온톨로지 색인 코퍼스(12,400장)',t:'Parquet',s:'6.4GB',c:'12,400',date:'2026-03-02'},
    ...
    ADMIN_AGENT_FOLDER_LINKS: [
      {agent:'금형 도면 온톨로지 검색',folders:['금형 도면 온톨로지','작업표준(SOP)']},
    ...
    ADMIN_APPROVAL_ROWS: [
      ...
      {id:'APR-103',type:'데이터 접근',user:'정재호',dept:'생산기술팀',date:'2026-02-11',status:'대기 중',desc:'금형 도면 온톨로지(등급 A) 학습 데이터 접근 권한 요청'},
    ],
    ADMIN_QUOTA_DEPTS: [
    ...
    ADMIN_PERM_MATRIX: {
      headers:['작업표준(SOP)','품질·검사 기준','사규·인사','구매·계약','교육자료','안전환경','금형 도면 온톨로지'],
      rows:[
    ...
    ADMIN_QUOTA_ADVICE: '생산기술팀(3,240건/월)과 품질관리부(2,880건/월)가 전체 사용량의 45%를 차지합니다. AX 로드맵 1단계(연 12억 원) 예산에 금형 도면 온톨로지 임베딩용 GPU 증설이 포함되어 있으니, 부서별 할당량을 함께 재설정해 리소스를 균형 있게 배분하세요.',
    ADMIN_USER_GROUPS: [
      {name:'생산본부',type:'부서 그룹',members:27,areas:['작업표준(SOP)','안전환경','품질·검사 기준'],perms:'읽기+쓰기 (등급 C 이하)'},
      {name:'설계지원그룹',type:'기능 그룹',members:9,areas:['금형 도면 온톨로지','작업표준(SOP)'],perms:'읽기+쓰기 (등급 A 열람 승인자 한정)'},
