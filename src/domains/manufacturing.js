...
const manufacturing = {
  ...
  orgName: "한빛정밀",
  orgShort: "HBP",
  platformTitle: "한빛정밀 QAgent — 멀티 AI 에이전트 플랫폼",
  brandColor: "#0F766E",
...
5. 후속 조치: 치료 종료 후 30일 이내에 결과 보고서를 제출하며, 해당 작업의 위험성평가를 재실시하고 재발 방지 대책을 수립하여 안전환경팀에 공유합니다.`,
  ...
  adminContent: {
    ...
    MOCK_AIACT_LABELING: [
      {id:'lb-01',target:'QAgent 채팅 응답',              type:'텍스트',method:'응답 하단 고지문 자동 삽입',                          enabled:true, coverage:100,  weekly:9840},
    ...
    MOCK_APIS: [
      {id:'api-001',name:'QAgent Chat API',            endpoint:'/api/v1/chat',            version:'v1.2',auth:'Bearer Token',status:'활성',callsToday:18420,approvedDate:'2026-01-05'},
    ...
    MOCK_ANNOUNCEMENTS: [
      {id:1,title:'QAgent AI 플랫폼 정식 오픈 안내',category:'공지',status:'Running',startDate:'2026-02-01',endDate:'2026-03-01',author:'임수진',views:452},
    ...
    MOCK_AIACT_SYSTEMS: [
      ...
      {id:'hi-005',name:'QAgent 업무지원 챗봇',dept:'스마트팩토리 혁신 TF',status:'비해당',confirmedAt:'2026-01-28',manager:'서동현 팀장',
    ...
    AIACT_STD_PHRASE: '본 내용은 한빛정밀 생성형 AI 플랫폼(QAgent)을 활용하여 작성되었습니다. 중요한 의사결정에는 담당자의 검토·확인이 필요합니다.',
  },
};
