...
const civic = {
  ...
  /* ── 결재 상신 전 AI 사전 검수 항목 (docType별) — 행정 문서 기준 ──
     status: 'pass'(자동 체크) | 'warn'(근거 확인 후 사용자가 체크해야 상신 가능) */
  selfChecks: {
    report: [
      { id: 'docnum', label: '문서번호 형식', desc: 'HSC-부서-연도-일련번호 체계 검증', status: 'pass',
        detail: 'HSC-안전총괄과-2026-063 — 형식 정상',
        basis: '문서번호를 시 문서관리규정의 부여 체계(기관코드-부서코드-연도-일련번호)와 대조한 결과 형식에 부합하며 일련번호 중복이 없습니다.' },
      { id: 'legal', label: '법적 근거 기재', desc: '처분·조치의 근거 법령과 조항 인용 여부', status: 'pass',
        detail: '자연재해대책법·풍수해 대응 매뉴얼 인용 확인',
        basis: '행정 문서는 근거 법령이 빠지면 처분의 정당성을 다투기 어렵습니다. 본문에 적용 법령과 조항이 명시되어 있음을 확인했습니다.' },
      { id: 'timeline', label: '조치 시각 기재', desc: '상황 인지·조치·보고 시각의 시계열 기록', status: 'pass',
        detail: '인지 06:40 · 조치 07:10 · 보고 08:00 기재됨',
        basis: '재난·상황 보고는 사후 감사에서 시각이 쟁점이 됩니다. 인지부터 보고까지 시각이 순서대로 기록되어 있습니다.' },
      { id: 'privacy', label: '개인정보 포함 여부', desc: '민원인 성명·연락처 등 식별정보 노출 점검', status: 'pass',
        detail: '식별정보 미포함 — 통계 형태로만 기재',
        basis: '민원 내용이 건수·유형 통계로만 기재되어 있고 개인 식별정보가 포함되지 않아 대외 공개 시에도 문제가 없습니다.' },
      ...
      { id: 'source', label: '자료 출처 명시', desc: '집계 수치의 원천 시스템·조회 시점 표기', status: 'warn',
        detail: '출처(NDMS·민원 접수 시스템) 미기재 — 하단 표기 권고',
        basis: '수치의 출처 시스템과 조회 시점이 없어 재확인이 어렵습니다. 문서 하단에 출처와 조회 일시를 남기실 것을 권고합니다.' },
      { id: 'followup', label: '후속 조치 계획', desc: '향후 조치 사항과 담당 부서 지정 여부', status: 'warn',
        detail: '후속 조치 담당 부서 미지정 — 보완 권고',
        basis: '후속 조치 항목은 있으나 담당 부서가 특정되지 않았습니다. 이행 주체가 없으면 조치가 누락되므로 부서를 지정하시길 권고합니다.' },
    ],
    meeting: [
      { id: 'docnum', label: '문서번호 형식', desc: 'HSC-부서-연도-일련번호 체계 검증', status: 'pass',
        detail: '형식 정상 — 일련번호 중복 없음',
        basis: '회의록 문서번호가 시 문서관리규정 부여 체계에 부합합니다.' },
      { id: 'attend', label: '참석자 정보 완전성', desc: '부서·직위 포함 참석자 명단 기재 여부', status: 'pass',
        detail: '참석자 전원 부서·직위 표기됨',
      ...
      { id: 'action', label: '액션 아이템 담당·기한', desc: '조치 항목마다 담당 부서와 기한 지정 여부', status: 'pass',
        detail: '액션 항목 전부 담당·기한 지정됨',
        basis: '추출된 조치 항목에 담당 부서와 기한이 지정되어 이행 점검이 가능합니다.' },
      { id: 'privacy', label: '개인정보·민감정보 점검', desc: '민원인 정보 등 비공개 대상 포함 여부', status: 'warn',
        detail: '민원 사례 언급 시 익명 처리 여부 확인 필요',
        basis: '회의 중 언급된 민원 사례에 개인 식별이 가능한 표현이 남아 있는지 확인이 필요합니다. 공개 대상 회의록이면 익명 처리 후 배포하십시오.' },
    ],
    safety: [
      { id: 'docnum', label: '문서번호 형식', desc: 'HSC-부서-연도-일련번호 체계 검증', status: 'pass',
        detail: '형식 정상',
        basis: '안전관리계획서 문서번호가 부여 체계에 부합합니다.' },
      { id: 'law', label: '법령 근거 기재', desc: '공연법·재난안전법 등 근거 조항 인용 여부', status: 'pass',
        detail: '재난 및 안전관리 기본법 근거 인용 확인',
        basis: '행사·시설 안전관리계획의 법적 근거가 인용되어 있습니다.' },
      ...
      { id: 'crowd', label: '인파 밀집 대응', desc: '수용 인원 산정과 동선·통제 계획 포함 여부', status: 'pass',
        detail: '수용 인원·동선 계획 명시됨',
        basis: '행사 안전에서 사고 비중이 가장 높은 항목이 인파 밀집입니다. 수용 인원 산정 근거와 출입 동선·통제 계획이 포함되어 있음을 확인했습니다.' },
      { id: 'emergency', label: '비상 연락·후송 체계', desc: '사고 시 신고 경로와 의료 후송 계획', status: 'pass',
        detail: '비상 연락 체계 및 인근 의료기관 지정 확인',
        basis: '119 신고 경로와 인근 의료기관 후송 계획이 기재되어 있습니다.' },
      { id: 'inspect', label: '사전 점검 일정', desc: '행사 전 현장 안전점검 일시·담당 지정', status: 'warn',
        detail: '사전 점검 일시·담당 미기재 — 보완 권고',
        basis: '점검 실시 여부만 있고 일시와 담당자가 특정되지 않았습니다. 이행 확인이 어려우므로 일시·담당을 기재하시길 권고합니다.' },
    ],
  },
  secureSuggestions: [
...
4. 비고
  ...
  /* ── 재난안전상황실 당직 인계 ──
     상황실은 24시간 3교대 상황근무다. 교대 시점에 진행 중인 상황이 안 넘어가면
     그대로 사고가 된다 — 호우경보 대응 서사와 같은 세계관으로 구성한다. */
  shiftHandover: {
    title: "상황실 당직 인계",
    hint: "상황 발생·조치·미결을 모아 다음 당직조에 넘깁니다",
    itemLabels: {
      alarm:   "상황 발생·경보",
      action:  "조치 완료",
      pending: "인계 사항(미결)",
    ...
    shifts: [
      { id: "A", label: "주간 당직", time: "09:00–18:00" },
      { id: "B", label: "야간 당직", time: "18:00–01:00" },
      { id: "C", label: "심야 당직", time: "01:00–09:00" },
    ],
    currentId: "B",
    previous: {
      shiftId: "A", author: "박도현 팀장", time: "18:10",
      items: [
        { type: "alarm",   text: "강변동 관측소 수위 2.84m — 주의수위(2.5m) 초과 지속, 상승 추세 시간당 +0.12m. 경계수위 3.2m 도달 예상 시각 재산출 필요" },
        { type: "action",  text: "침수·배수 신고 47건 접수분 전건 현장 확인 완료 — 배수펌프장 4개소 전량 가동, 하천변 산책로 3개 구간 출입 통제" },
        { type: "action",  text: "상황보고 1보 작성·보고 완료 (HSC-안전총괄과-2026-063)" },
        { type: "pending", text: "강변동 하천 정비 공사 구간 임시 제방 — 공사 중지·장비 대피 09:30 완료됐으나 야간 순찰 필요" },
        { type: "pending", text: "비상 2단계 격상 여부 — 경계수위 도달 시 즉시 판단. 부시장 보고 라인 대기 중" },
        { type: "quality", text: "공단동 반지하 주택 3세대 대피 안내 완료, 1세대는 연락 두절 — 통장 통해 재확인 요청함" },
      ],
    },
    draftSeed: {
      alarms: [
        "기상청 호우경보 유지 — 자정까지 시간당 20~30mm 추가 강우 예보",
      ],
      actions: [
        "하천변 통제 구간 야간 순찰 1회차 완료 — 임시 제방 이상 없음",
        "연락 두절 1세대 소재 확인 완료 — 친척 집 대피 중",
      ],
      pending: [
        "경계수위 도달 시 비상 2단계 격상 및 상황보고 2보 작성 — 심야 당직 인계",
        "배수펌프장 3호기 토출 압력 저하 — 익일 오전 시설관리공단 점검 요청 예정",
      ],
      quality: [
        "금일 재난 관련 민원 63건 접수 — 침수 47 · 통제 문의 11 · 기타 5",
      ],
    },
    note: "확정하면 다음 당직조의 '받은 인계'로 넘어갑니다. 실서비스에서는 NDMS 상황일지·당직 근무일지와 연동됩니다.",
  },

  /* ── 조치 지시 추적 ── */
  workOrderSeed: [
    { docNo: "HSC-안전총괄과-2026-063", title: "하천변 통제 구간 야간 순찰 및 수위 감시",
      source: "재난 상황보고 시나리오", owner: "안전총괄과 박도현", due: "2026-03-22",
      status: "작업중", updatedAt: "2026-03-21 19:40",
      history: [
        { status: "발행", at: "2026-03-21 10:20", by: "AI 자동 발행" },
        { status: "작업중", at: "2026-03-21 19:40", by: "안전총괄과 박도현" },
      ] },
    { docNo: "HSC-건설과-2026-071", title: "배수펌프장 3호기 토출 압력 저하 점검",
      source: "당직 인계 사항", owner: "건설과 이준호", due: "2026-03-24",
      status: "발행", updatedAt: "2026-03-21 20:05",
      history: [{ status: "발행", at: "2026-03-21 20:05", by: "안전총괄과 박도현" }] },
    { docNo: "HSC-민원여권과-2026-052", title: "옥외광고물 허가 신청 12건 보완 요청 회신",
      source: "옥외광고물 허가 시나리오", owner: "민원여권과 이서연", due: "2026-03-18",
      status: "완료", updatedAt: "2026-03-18 14:30",
      history: [
        { status: "발행", at: "2026-03-16 11:00", by: "AI 자동 발행" },
        { status: "작업중", at: "2026-03-17 09:30", by: "민원여권과 이서연" },
        { status: "완료", at: "2026-03-18 14:30", by: "민원여권과 이서연" },
      ] },
    { docNo: "HSC-안전총괄과-2026-051", title: "벚꽃축제 임시 무대·전기 설비 위험성평가 조치",
      source: "행사 안전 점검", owner: "안전총괄과 김하늘", due: "2026-03-17",
      status: "검증완료", updatedAt: "2026-03-19 09:20",
      history: [
        { status: "발행", at: "2026-03-14 13:40", by: "안전총괄과 김하늘" },
        { status: "작업중", at: "2026-03-15 10:00", by: "안전총괄과 김하늘" },
        { status: "완료", at: "2026-03-17 16:50", by: "안전총괄과 김하늘" },
        { status: "검증완료", at: "2026-03-19 09:20", by: "안전총괄과 박도현" },
      ] },
  ],
  workOrderNote: "자동화 시나리오가 문서를 발행하면 여기에 자동 등록됩니다. 실서비스에서는 새올행정시스템 업무지시·NDMS 조치사항과 양방향 연동됩니다.",

  /* ── 코드 스캔 ──
     시설물 관리번호 QR은 지자체 현장에 실제로 부착돼 있다.
     현장 점검자가 찍으면 해당 시설의 업무로 바로 들어간다. */
  scanLabel: "시설물·접수증 코드 스캔",
  scanRegistry: [
    { code: "HSC-RV-012", type: "equip", label: "강변동 하천 수위 관측소 — 재난 상황 확인",
      agentId: "orchestration:1" },
    { code: "HSC-PMP-03", type: "equip", label: "배수펌프장 3호기 — 점검 지시 확인",
      query: "배수펌프장 3호기 점검 이력과 조치 사항을 알려줘" },
    { code: "HSC-BR-047", type: "equip", label: "노후 육교 47호 — 안전점검 계획 수립",
      agentId: "agent-safety" },
    { code: "MW-2026-0318", type: "lot", label: "민원 접수증 0318 — 옥외광고물 허가 처리",
      agentId: "orchestration:0" },
    { code: "HSC-EV-0405", type: "order", label: "벚꽃축제 행사장 — 행사 안전관리 계획",
      agentId: "agent-safety" },
  ],
  ...
  adminContent: {
    ...
    /* ── 망분리 보안 아키텍처 ──
       지자체는 행정안전부 망분리 지침에 따라 행정정보망(내부)과 인터넷망이 물리 분리된다.
       주민 개인정보가 경계를 넘는 순간이 통제 지점이다. */
    MOCK_DATA_FLOWS: [
      { id: 'df-1', name: '자치법규·민원사무편람 RAG 검색', source: '문서관리시스템', zone: '행정정보망', processedAt: '내부 GPU 서버', dest: '행정정보망 사용자', crossing: false, dataClass: '내부', volume: '일 8,200건', encryption: '전송 TLS 1.3 · 저장 AES-256', status: '정상' },
      { id: 'df-2', name: '민원 접수 이력 조회', source: '새올행정시스템 연계', zone: '행정정보망', processedAt: '내부 분석 서버', dest: '행정정보망 사용자', crossing: false, dataClass: '대외비', volume: '일 1,240건', encryption: '전송 TLS 1.3 · 저장 AES-256 · 신청인 식별정보 분리보관', status: '정상' },
      { id: 'df-3', name: '재난 상황 데이터 수집(기상청·수위계측)', source: '외부 관측 API', zone: '인터넷망', processedAt: 'DMZ 수집 서버', dest: '재난안전상황실', crossing: true, dataClass: '공개', volume: '10분 주기', encryption: '단방향 반입(내부→외부 요청 없음)', status: '정상' },
      { id: 'df-4', name: '플래그십 모델 질의(보안 게이트웨이 경유)', source: '주무관 질의', zone: '행정정보망', processedAt: '외부 상용 LLM', dest: '행정정보망 사용자', crossing: true, dataClass: '공개', volume: '일 520건', encryption: '전송 TLS 1.3 · 성명·주소·연락처·주민등록번호 마스킹 후 전송', status: '통제 중' },
      { id: 'df-5', name: '민원 회신문 대외 발송', source: '내부 작성 문서', zone: '행정정보망', processedAt: '반출 검증 서버', dest: '민원인(전자우편·우편)', crossing: true, dataClass: '대외비', volume: '일 380건', encryption: '결재 승인 후 반출 · 발송 이력 보존', status: '통제 중' },
    ],
    MOCK_BOUNDARY_POLICY: [
      { grade: '기밀',   label: 'C', internal: '허용', gateway: '차단',   external: '차단', note: '주민등록·세무 자료 — 고유식별정보 포함. 내부 GPU에서만 처리하며 게이트웨이 경유 자체가 차단' },
      { grade: '대외비', label: 'S', internal: '허용', gateway: '조건부', external: '차단', note: '민원 신청인 정보 — 마스킹 후에만 게이트웨이 경유, 승인 이력 필수' },
      { grade: '내부',   label: 'I', internal: '허용', gateway: '허용',   external: '차단', note: '자치법규·업무 편람. 외부 직접 전송은 불가' },
      { grade: '공개',   label: 'O', internal: '허용', gateway: '허용',   external: '허용', note: '공표된 조례·고시·통계. 제한 없음' },
    ],
    MOCK_EXTERNAL_ACCESS: [
      { id: 'ex-1', org: '한성시 시설관리공단', user: '위탁 담당자 1', scope: '시설 점검 이력 등록', grade: '내부', expires: '2026-12-31', mfa: true, lastAccess: '2026-03-21 11:20', status: '활성' },
      { id: 'ex-2', org: '재난안전 용역업체', user: '용역 담당자 1', scope: '하천 수위 계측 자료 제출', grade: '내부', expires: '2026-06-30', mfa: true, lastAccess: '2026-03-21 08:05', status: '활성' },
      { id: 'ex-3', org: '경기도청', user: '도 담당자 1', scope: '집계 통계 열람(개별 민원 불가)', grade: '공개', expires: '2026-12-31', mfa: true, lastAccess: '2026-03-19 15:44', status: '활성' },
      { id: 'ex-4', org: '옥외광고 심의 위원', user: '외부 위원 2', scope: '심의 안건 자료 열람', grade: '내부', expires: '2026-02-29', mfa: false, lastAccess: '2026-02-26 10:30', status: '만료' },
    ],

    /* ── 예측 모델 운영(MLOps) ── */
    MOCK_PRED_MODELS: [
      { id: 'pm-1', name: '민원 접수량 예측 모델', task: '회귀', version: 'v2.3', deployed: '2026-01-15',
        metricName: 'MAE(건)', baseline: 24.0, current: 31.0, threshold: 35.0, status: '정상',
        samples: '일 1,240건', owner: '정보통신과', nextRetrain: '2026-04-15' },
      { id: 'pm-2', name: '침수 위험 예측 모델', task: '이진분류', version: 'v1.8', deployed: '2025-11-02',
        metricName: 'F1', baseline: 0.88, current: 0.83, threshold: 0.85, status: '주의',
        samples: '강우 이벤트 42건', owner: '안전총괄과', nextRetrain: '재학습 검토 중' },
    ],
    MOCK_PRED_TREND: [
      { month: '2025.10', '민원 접수량 예측 모델': 24.0, '침수 위험 예측 모델': 0.88 },
      { month: '2025.12', '민원 접수량 예측 모델': 26.0, '침수 위험 예측 모델': 0.87 },
      { month: '2026.02', '민원 접수량 예측 모델': 29.0, '침수 위험 예측 모델': 0.85 },
      { month: '2026.03', '민원 접수량 예측 모델': 31.0, '침수 위험 예측 모델': 0.83 },
    ],
    MOCK_PRED_DRIFT: [
      { feature: '하천변 지형 조건', psi: 0.34, level: '주의', note: '강변동 하천 정비 공사로 임시 제방 구간 발생 — 학습 시점 지형과 상이' },
      { feature: '민원 접수 채널 구성비', psi: 0.22, level: '주의', note: '온라인 접수 비중 증가로 분포 이동' },
      { feature: '강우 강도 분포', psi: 0.10, level: '정상', note: '유의미한 변화 없음' },
      { feature: '요일·시간대', psi: 0.05, level: '정상', note: '유의미한 변화 없음' },
    ],
    MOCK_RETRAIN_RUNS: [
      { id: 'rt-1', model: '침수 위험 예측 모델', trigger: '성능 임계 초과', started: '2026-03-28 02:00',
        champion: 0.83, challenger: 0.89, verdict: '승격 대기', note: '공사 구간 지형 변경분 반영. 재난 대응에 직접 쓰이므로 안전총괄과 확인 후 배포' },
      { id: 'rt-2', model: '민원 접수량 예측 모델', trigger: '정기(분기)', started: '2026-01-15 02:00',
        champion: 29.0, challenger: 24.0, verdict: '승격 완료', note: 'v2.3으로 배포됨 · 창구 인력 배치 계획에 반영' },
    ],

    /* ── 데이터 카탈로그 · 리니지 ── */
    MOCK_DATA_ASSETS: [
      { id: 'as-1', name: '자치법규·민원사무편람', source: '자치법규정보시스템 연계', owner: '자치행정과', grade: '내부',
        format: 'PDF·HWP', volume: '문서 2,180건', cycle: '개정 시 수시', freshness: '1일 전', quality: 93, standardized: 100,
        tags: ['RAG 대상', '자치법규'], consumers: ['지식 검색', '내규 조회', '공문 검토'] },
      { id: 'as-2', name: '민원 접수·처리 이력', source: '새올행정시스템', owner: '민원여권과', grade: '대외비',
        format: '관계형 테이블', volume: '일 1,240행', cycle: '실시간 연계', freshness: '10분 전', quality: 89, standardized: 78,
        tags: ['TAG 대상', '집계'], consumers: ['행정 데이터 조회', '민원 동향 분석', '보고서 작성'] },
      { id: 'as-3', name: '재난 관측 자료(수위·강우)', source: '기상청·하천 자동계측', owner: '안전총괄과', grade: '공개',
        format: '시계열', volume: '10분 주기 · 관측소 12개소', cycle: '10분', freshness: '4분 전', quality: 96, standardized: 92,
        tags: ['실시간', '재난'], consumers: ['재난 상황보고 시나리오', '침수 위험 예측 모델'] },
      { id: 'as-4', name: '인허가 신청 서류 스캔본', source: '민원 창구 스캔', owner: '민원여권과', grade: '대외비',
        format: '이미지', volume: '월 640건', cycle: '수시', freshness: '2일 전', quality: 72, standardized: 44,
        tags: ['OCR 대상'], consumers: ['문서 인식(OCR)', '주소 표준화'] },
    ],
    MOCK_DATA_LINEAGE: {
      'as-1': { upstream: [{ name: '조례·규칙 원본', type: '문서' }, { name: '상위 법령 개정 통보', type: '외부 시스템' }],
        stages: [{ name: '수집', desc: '자치법규정보시스템 연동 수집', tool: '커넥터' },
                 { name: '청킹', desc: '조·항·호 단위 분할', tool: 'RAG 파이프라인' },
                 { name: '임베딩', desc: '벡터 생성·색인', tool: '임베딩 엔진' }],
        downstream: [{ name: '지식 검색 에이전트', type: '에이전트' }, { name: '공문 검토 에이전트', type: '에이전트' }] },
      'as-2': { upstream: [{ name: '창구·온라인 접수', type: '외부 시스템' }, { name: '부서 처리 결과 등록', type: 'DB' }],
        stages: [{ name: '연계 수집', desc: '새올행정시스템 실시간 연계', tool: 'ETL' },
                 { name: '개인정보 분리', desc: '신청인 식별정보 별도 보관·대체키 부여', tool: '비식별 처리' },
                 { name: '분류 표준화', desc: '민원 유형 코드 정규화', tool: '기준정보 사전' },
                 { name: '적재', desc: '분석 DB 적재', tool: '분석 DB' }],
        downstream: [{ name: '행정 데이터 조회', type: '에이전트' }, { name: '민원 접수량 예측 모델', type: '예측 모델' }] },
      'as-3': { upstream: [{ name: '기상청 특보·관측 API', type: '외부 API' }, { name: '하천 수위 자동계측기', type: '센서' }],
        stages: [{ name: '수집', desc: 'DMZ 수집 서버 단방향 반입', tool: '수집 게이트웨이' },
                 { name: '결측 보정', desc: '통신 두절 구간 보간·이상값 제거', tool: '전처리' },
                 { name: '임계 판정', desc: '주의·경계 수위 대비 판정', tool: '경보 룰' }],
        downstream: [{ name: '재난 상황보고 시나리오', type: '오케스트레이션' }, { name: '실시간 수위 경보', type: '알림' }] },
      'as-4': { upstream: [{ name: '창구 제출 서류', type: '이미지' }],
        stages: [{ name: '전처리', desc: '기울기·노이즈 보정', tool: '이미지 전처리' },
                 { name: 'OCR', desc: '신청서 항목·표 인식', tool: 'Vision OCR' },
                 { name: '주소 매칭', desc: '도로명주소 정규화', tool: '주소 표준화' }],
        downstream: [{ name: '문서 인식(OCR) 에이전트', type: '에이전트' }, { name: '주소 표준화 에이전트', type: '에이전트' }] },
    },

    /* ── 지식 증강 전략 (RAG · CAG · TAG) ── */
    MOCK_AUG_STRATEGIES: [
      { id: 'rag', name: 'RAG', full: 'Retrieval-Augmented Generation', desc: '벡터 검색으로 조례·편람 조항을 찾아 답변',
        targets: ['자치법규', '민원사무편람'], share: 61, avgLatency: 1210, hitRate: 90, costPer1k: '₩24',
        strength: '조례 개정이 잦고 상위 법령과 연결돼 있어도 최신 조항으로 대응', caveat: '검색 지연이 있고 조·항 단위 청킹 품질에 좌우된다' },
      { id: 'cag', name: 'CAG', full: 'Cache-Augmented Generation', desc: '민원 응대 표준 답변을 캐시에 적재해 검색 없이 답변',
        targets: ['여권·인허가 구비서류·처리기한'], share: 24, avgLatency: 310, hitRate: 97, costPer1k: '₩11',
        strength: '창구 응대 표준 문구가 담당자마다 달라지지 않는다', caveat: '수수료·기한이 개정되면 즉시 재적재해야 한다' },
      { id: 'tag', name: 'TAG', full: 'Table-Augmented Generation', desc: '자연어를 SQL로 변환해 민원·재난 데이터를 집계',
        targets: ['민원 접수·처리 이력', '재난 관측 자료'], share: 15, avgLatency: 880, hitRate: 89, costPer1k: '₩18',
        strength: '"강변동 이번 주 민원 건수" 같은 수치는 집계해야 정확', caveat: '민원 유형 코드가 표준화돼 있어야 한다' },
    ],
    MOCK_AUG_ROUTES: [
      { id: 'rt-1', order: 1, when: '민원 건수·처리기간·수위 등 수치 질의', keywords: '건수, 처리기간, 수위, 추이, 대비', strategy: 'TAG', hits: 1180, enabled: true },
      { id: 'rt-2', order: 2, when: '구비서류·수수료·처리기한 조회', keywords: '구비서류, 수수료, 처리기한, 신청 자격', strategy: 'CAG', hits: 2140, enabled: true },
      { id: 'rt-3', order: 3, when: '그 외 조례·법령 근거가 필요한 질의', keywords: '(기본 경로)', strategy: 'RAG', hits: 4620, enabled: true },
    ],
    MOCK_CAG_CACHE: [
      { id: 'cc-1', name: '여권 발급 구비서류·처리기한', tokens: '34K', loaded: '2026-03-18 02:10', sourceRev: 'v5 (2026-03-17)', status: '최신', hits: 1860 },
      { id: 'cc-2', name: '옥외광고물 허가 기준 요약', tokens: '26K', loaded: '2026-03-12 02:10', sourceRev: 'v3 (2026-03-11)', status: '최신', hits: 720 },
      { id: 'cc-3', name: '민원 처리기한·수수료 표', tokens: '19K', loaded: '2026-02-14 02:10', sourceRev: 'v9 (2026-03-20)', status: '재적재 필요', hits: 540 },
    ],

    /* ── 중대재해처벌법 대응 (지자체장도 경영책임자 — 시설·공사 현장이 핵심 위험) ── */
    MOCK_SAFETY_DUTIES: [
      { id: 'sd-1', clause: '제1호', name: '안전보건 목표·경영방침 설정', status: '이행', evidence: '2026년 시 안전보건 경영방침 공표', last: '2026-01-08', owner: '안전총괄과', auto: false },
      { id: 'sd-2', clause: '제2호', name: '안전보건 전담 조직 구성', status: '이행', evidence: '안전총괄과 내 전담 조직 지정서', last: '2026-01-12', owner: '안전총괄과', auto: false },
      { id: 'sd-3', clause: '제3호', name: '유해·위험요인 확인·개선 절차', status: '이행', evidence: '공사·행사 위험성평가 이력 (플랫폼 자동 축적)', last: '2026-03-21', owner: '안전총괄과', auto: true },
      { id: 'sd-4', clause: '제4호', name: '재해예방 예산 편성·집행', status: '이행', evidence: '2026년 안전 예산 집행 내역', last: '2026-03-18', owner: '기획예산과', auto: false },
      { id: 'sd-5', clause: '제5호', name: '안전보건관리책임자 업무 수행 평가', status: '주의', evidence: '반기 평가 1개 부서 미제출', last: '2026-01-30', owner: '안전총괄과', auto: false },
      { id: 'sd-6', clause: '제6호', name: '안전 담당 인력 배치', status: '이행', evidence: '사업장별 안전 담당 지정 현황', last: '2026-02-10', owner: '안전총괄과', auto: false },
      { id: 'sd-7', clause: '제7호', name: '종사자 의견 청취 절차', status: '이행', evidence: '현장 종사자 의견청취 결과 (플랫폼 자동 축적)', last: '2026-03-19', owner: '안전총괄과', auto: true },
      { id: 'sd-8', clause: '제8호', name: '중대재해 대응 매뉴얼 마련', status: '이행', evidence: '풍수해·시설 사고 비상대응 매뉴얼 v4', last: '2026-02-05', owner: '안전총괄과', auto: false },
      { id: 'sd-9', clause: '제9호', name: '도급·위탁 시 안전 확보 기준', status: '미이행', evidence: '하천 정비 공사 수급업체 안전 평가 미실시', last: '2025-12-20', owner: '건설과', auto: false },
    ],
    MOCK_SAFETY_RISK_LOG: [
      { id: 'sr-1', task: '강변동 하천 정비 공사 (임시 제방 구간)', doc: 'HSC-안전총괄과-2026-058', assessed: '2026-03-21', by: '박도현', risks: 8, actions: 5, status: '조치 중' },
      { id: 'sr-2', task: '벚꽃축제 임시 무대·전기 설비', doc: 'HSC-안전총괄과-2026-051', assessed: '2026-03-14', by: '김하늘', risks: 6, actions: 6, status: '조치 완료' },
      { id: 'sr-3', task: '노후 육교 정밀안전점검', doc: 'HSC-건설과-2026-044', assessed: '2026-03-06', by: '이준호', risks: 5, actions: 5, status: '조치 완료' },
      { id: 'sr-4', task: '제설 작업 차량 운행', doc: 'HSC-안전총괄과-2026-031', assessed: '2026-01-22', by: '박도현', risks: 4, actions: 4, status: '조치 완료' },
    ],
    MOCK_SAFETY_TRAINING: [
      { id: 'st-1', name: '관리감독자 안전보건 교육 (정기)', target: '부서 안전 담당', done: 64, total: 64, date: '2026-03-04', status: '완료' },
      { id: 'st-2', name: '풍수해 비상대응 훈련', target: '재난 대응 인력', done: 112, total: 112, date: '2026-03-12', status: '완료' },
      { id: 'st-3', name: '수급업체 안전 교육', target: '공사 수급업체 종사자', done: 46, total: 78, date: '2026-03-20', status: '진행 중' },
      { id: 'st-4', name: '행사장 안전관리 특별교육', target: '축제·행사 담당', done: 38, total: 55, date: '2026-03-25', status: '진행 중' },
    ],

    /* ── 답변 재현성 (정보공개청구·감사 대응 5년 보존) ── */
    MOCK_REPRO_SNAPSHOTS: [
      { id: 'sn-1', at: '2026-03-21 14:05', question: '긴급 여권 발급 구비서류와 처리기한이 어떻게 되나요?',
        strategy: 'CAG', model: 'Llama-3-Korean 70B', modelVer: 'v1.4', kbRev: 'kb-2026.03.17',
        promptVer: 'p-2.1', temp: 0.2, guardrailVer: 'g-1.8', confidence: 97,
        sources: [{ name: '여권 발급 구비서류·처리기한', rev: 'v5 (2026-03-17)' }],
        reproducible: true, drift: [] },
      { id: 'sn-2', at: '2026-03-21 09:22', question: '지금 강변동 침수 신고 몇 건이고 수위는 얼마인가요?',
        strategy: 'TAG', model: 'Llama-3-Korean 70B', modelVer: 'v1.4', kbRev: 'kb-2026.03.20',
        promptVer: 'p-2.1', temp: 0.1, guardrailVer: 'g-1.8', confidence: 93,
        sources: [{ name: '재난안전상황실 접수 대장', rev: '2026-03-21 09:00 기준' }, { name: '하천 수위 자동계측(강변동)', rev: '10분 주기' }],
        reproducible: false, drift: ['실시간 관측값 기반 답변 — 같은 질의라도 시점이 다르면 값이 달라진다(정상)', '접수 대장 마감 후 신고 3건 추가 반영(47 → 50건)'] },
      { id: 'sn-3', at: '2026-03-12 16:18', question: '옥외광고물 허가 기준과 심의 절차를 정리해줘',
        strategy: 'RAG', model: 'Llama-3-Korean 70B', modelVer: 'v1.4', kbRev: 'kb-2026.03.11',
        promptVer: 'p-2.0', temp: 0.2, guardrailVer: 'g-1.7', confidence: 92,
        sources: [{ name: '옥외광고물 관리 조례', rev: 'v3 (2026-03-11)' }],
        reproducible: false, drift: ['프롬프트 개정 p-2.0 → p-2.1', '가드레일 g-1.7 → g-1.8 (조례 인용 시 조·항 명시 강제)'] },
      { id: 'sn-4', at: '2026-02-26 10:40', question: '민원 처리기한 연장 사유는 어떤 경우에 인정되나요?',
        strategy: 'RAG', model: 'Llama-3-Korean 70B', modelVer: 'v1.3', kbRev: 'kb-2026.02.14',
        promptVer: 'p-2.0', temp: 0.2, guardrailVer: 'g-1.7', confidence: 88,
        sources: [{ name: '민원 처리기한·수수료 표', rev: 'v8 (2026-02-10)' }],
        reproducible: false, drift: ['모델 교체 v1.3 → v1.4', '근거 문서 개정 v8 → v9 (2026-03-20 수수료 개정 반영)'] },
    ],
    MOCK_REPRO_POLICY: {
      retentionYears: 5,
